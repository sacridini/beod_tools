...
int main(int argc, char** argv) {
	...
	if (argc != 5) {
		...
		cout << "sub <tipo do dado> <imagem de entrada 1> <imagem de entrada 2> <imagem de saída>" << endl;
		cout << "Exemplo:" << endl;
		cout << "sub -byte input1.tif input2.tif output.tif" << endl;
		cout << "#################################################################################" << endl;
		exit(1);
	}
...
/*	vector< string > args;
	...
	sub(dType, input_1_filename, input_2_filename, output_filename);
...
// g++ -o sub sub.cpp -I /usr/include/gdal -lgdal